...
Guide a human through completing a coding task themselves. Use this skill when the STP ratio is unhealthy (too much AI-written code) and the human needs to write code to improve their ratio.
...
2. **Offer code pointers to relevant files**: Show the user which files they need to modify, and which lines, and what they need to do there.

3. **Provide test instructions**: Tell the user how they can test their change and verify correctness.

4. **Ask if the user wants more help**: If they want more help, provide guidance including code snippets or other in depth hand holding.
