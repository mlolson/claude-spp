...
import { z } from "zod";
import { getTaskSubdir } from "./directories.js";
/**
 * Task category types
 */
...
function parseMetadata(content) {
    ...
    if (difficultyMatch) {
        ...
        if (parsed.success)
            defaults.difficulty = parsed.data;
    }
    // Parse category
 ...
 */
function parseCompletionNotes(content) {
    const notes = {
        completedBy: null,
        completedAt: null,
        notes: null,
 ...
 */
export function parseTaskFile(projectPath, filename, directory) {
 ...
 */
export function parseTasksInDirectory(projectPath, directory) {
 ...
 */
export function parseActiveTasks(projectPath) {
    return [
 ...
 */
export function parseAllTasks(projectPath) {
    return [
 ...
 */
export function findTask(projectPath, filename) {
