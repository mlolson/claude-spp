 ...
 */
export function hasPairSession(projectPath) {
 ...
 */
export function loadPairSession(projectPath) {
    const sessionPath = getSessionPath(projectPath);
 ...
 */
export function savePairSession(projectPath, session) {
    const sessionPath = getSessionPath(projectPath);
 ...
 */
export function startPairSession(projectPath, task, startingDriver = "claude") {
    const session = {
 ...
 */
export function endPairSession(projectPath) {
 ...
 * Rotate the driver
 */
export function rotateDriver(projectPath) {
    const session = loadPairSession(projectPath);
    if (!session) {
        return null;
    }
 ...
 */
export function recordContribution(projectPath, by) {
    const session = loadPairSession(projectPath);
    if (!session) {
        return null;
    }
 ...
 */
export function shouldSuggestRotation(session) {
    return session.contributionsSinceRotation >= 3;
}
/**
 * Get the other driver
 */
export function otherDriver(driver) {
 ...
 */
export function formatPairSession(session) {
...
//# sourceMappingURL=pair-session.js.map