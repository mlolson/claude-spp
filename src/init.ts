...
import { DEFAULT_CONFIG, type Config, type Preset, PRESET_RATIOS, PresetSchema } from "./config/schema.js";
 ...
 */
function generateDojoInstructions(preset: Preset): string {
 ...
 */
function updateClaudeMd(projectPath: string, preset: Preset): void {
 ...
 */
export async function initializeDojo(projectPath: string, preset?: Preset): Promise<Config> {
 ...
 */
export async function ensureInitialized(projectPath: string, preset?: Preset): Promise<Config> {
